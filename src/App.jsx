...
function App() {
  ...
  return <div className="site">
    <div className="topbar"><div className="container topbar-inner">
      ...
      <span className="top-contact"><a href="tel:+442081445555"><Phone size={14}/> 0208 144 5555</a><a href="tel:+447412850832"><MessageCircle size={14}/> 07412 850832</a><a href="mailto:londonairporttravelservices@gmail.com"><Mail size={14}/> Email us</a></span>
    </div></div>
    ...
    <main>
      ...
      <section id="contact" className="cta"><div className="container cta-inner"><div><span className="eyebrow">READY TO TRAVEL?</span><h2>Let's get your airport transfer <em>booked.</em></h2><p>Send your journey details on WhatsApp and we'll get back to you.</p></div><div className="cta-actions"><WhatsAppButton>Book on WhatsApp</WhatsAppButton><a className="email-link" href="mailto:londonairporttravelservices@gmail.com"><Mail size={18}/> londonairporttravelservices@gmail.com</a></div></div></section>
    </main>

    <footer><div className="container footer-grid"><div><a className="brand footer-brand" href="#home"><span className="brand-mark"><Plane size={21}/></span><span><strong>London Airport</strong><small>Travel Services</small></span></a><p>Private airport transfers across London. Simple booking through WhatsApp.</p></div><div><h4>Quick links</h4><a href="#airports">Airports</a><a href="#services">Services</a><a href="#vehicles">Vehicles</a><a href="#faq">FAQ</a></div><div><h4>Contact</h4><a href="tel:+442081445555"><Phone size={15}/> 0208 144 5555</a><a href="https://wa.me/447412850832" target="_blank" rel="noreferrer"><MessageCircle size={15}/> 07412 850832</a><a href="mailto:londonairporttravelservices@gmail.com"><Mail size={15}/> Email us</a><span><MapPin size={15}/> 9 Town Quay Wharf<br/>Abbey Road, Barking, England, IG11 7BZ</span></div></div><div className="container footer-bottom"><span>© {new Date().getFullYear()} London Cars 247. All rights reserved.</span><span>Airport transfers • London</span></div></footer>
